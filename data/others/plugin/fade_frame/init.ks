...
[macro name="hide_frame"]
  ...
  $(`.layer.${layer} .message_inner`).hide();
  $(`.layer.${layer} .message_outer`).hide();
  $(".fixlayer").hide();
...
[macro name="transparent_frame"]
  ...
  $(`.layer.${layer}`).children().css("opacity", 0).css('display', '');
  $(`.layer.${layer} .message_inner`).css("opacity", 0).css('display', '');
  $(`.layer.${layer} .message_outer`).css("opacity", 0).css('display', '');
  $(".fixlayer").not('[l_visible="false"]').css("opacity", 0).css('display', '');

...
module.exports = class plugin_setting {
  constructor(TB) {
    ...
    this.plugin_text = TB.$.s(
      'ゲーム画面にフィルターをかけるコンポーネントが追加されます。効果はグレースケール・セピア・階調反転・透明度・ぼかし'
    )
  ...
  defineComponents() {
    ...
    cmp['tb_filter_grayscale'] = {
      info: {
        ...
        name: TB.$.s('グレースケール効果'),
        help: TB.$.s(
          'ゲーム画面にグレースケール効果をかけるコンポーネントが追加されます'
        ),
      ...
      component: {
        ...
        param: {
          ...
          time: {
            ...
            name: TB.$.s('フェードイン時間'),
            default_val: 0,
            help: TB.$.s('フェードインにかかる時間を設定できます'),
            onChange: function (val, component) {
              TB.component.changeParam(component, 'time', val)
            },
          },
        },
      },
    ...
    cmp['tb_filter_invert'] = {
      info: {
        ...
        name: TB.$.s('階調反転効果'),
        help: TB.$.s(
          'ゲーム画面に階調反転効果をかけるコンポーネントが追加されます'
        ),
        icon: 's-icon-star-full',
      },
    ...
    cmp['tb_free_filter'] = {
      info: {
        ...
        name: TB.$.s('フィルター解除'),
        help: TB.$.s(
          'ゲーム画面のフィルター効果を解除できます。nameを指定すると特定のフィルターのみ解除することも可能'
        ),
        icon: 's-icon-star-full',
      },
      ...
      component: {
        ...
        param: {
          ...
          time: {
            ...
            name: TB.$.s('フェードアウト時間'),
            default_val: 0,
            help: TB.$.s('フェードアウトにかかる時間を設定できます'),
            onChange: function (val, component) {
              TB.component.changeParam(component, 'time', val)
            },
          },

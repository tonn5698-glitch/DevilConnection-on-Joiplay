...
[tb_start_text mode=1 ]
#でびるん
Ờm...Tên hắn là Asmodeus。[r]Ác quỷ dâm dục。[p]
[_tb_end_text]

[tb_start_text mode=1 ]
#でびるん
Hắn thường hóa thành dạng non trên mặt đất rồi tấn công bất ngờ。[r]Đực hay cái đều không quan trọng, kẻ đáng sợ lắm[p]
[_tb_end_text]
...
[tb_start_text mode=1 ]
#クピャドエル
...Khi ta lần đầu gặp debi-kun[r]ta đã bị con ác quỷ đó tấn công[p]
...
[tb_start_text mode=1 ]
#でびるん
Gh...Lúc đó ngã xuống là...[r]là do hắn gây ra sao![p]
[_tb_end_text]
...
[tb_start_text mode=1 ]
#クピャドエル
Đùa giỡn với debi-kun thế mà[r][font size=25]đáng ghét quá![resetfont][p]
[_tb_end_text]
...
[tb_start_text mode=1 ]
#クピャドエル
Ta thường nghetin đồn về ngài ấy ở thiên giới[r]Hình như sở thích của hắn là tấn công thiên sứ thuần khiết...[p]

[_tb_end_text]

[tb_start_text mode=1 ]
#クピャドエル
Kupya...Ta đã thoát kịp lúc[các thiên sứ bị tấn công đều sa ngã hết rồi...[p]
[_tb_end_text]

[chara_mod  name="劇場でび"  time="0"  cross="false"  storage="chara/15/dagya20.png"  ]
[tb_start_text mode=1 ]
#でびるん
Hắn được gọi là thiên sứ của ma giới。[r]Vậy nên...hắn có ngưỡng mộ thiên sứ gì đó không nhỉ？[p]
[_tb_end_text]

[chara_mod  name="劇場える"  time="0"  cross="false"  storage="chara/16/kupya4.png"  ]
[tb_start_text mode=1 ]
#クピャドエル
Nhưng mà...nhờ vậy mà ta đã[r]gặp được debi-kun, thật tốt[p]
[_tb_end_text]

[chara_mod  name="劇場でび"  time="0"  cross="false"  storage="chara/15/dagya24.png"  ]
[tb_start_text mode=1 ]
#でびるん
Vậy sao...do hắn mà Deu-el đã[bị ô nhiễm đến mức này...[p]
[_tb_end_text]
...
[tb_start_text mode=1 ]
#クピャドエル
[font size=25]Hừ, đó là tại debi-kun đó![resetfont][p]
[_tb_end_text]

[tb_start_text mode=1 ]
#でびるん
[font size=37]Gyaa![resetfont][p]
[_tb_end_text]

...
[iscript]
; optinal
if(mp.name ==null)console.error('Trường name là bắt buộc');
...
; optinal
if(mp.name ==null)console.error('Trường name là bắt buộc');
if(mp.opacity ==null)console.error('Trường opacity là bắt buộc');
if(mp.time == null)mp.time = 1000;
...
; optinal
if(mp.name ==null)console.error('Trường name là bắt buộc');
if(mp.left ==null)console.error('Trường left là bắt buộc');
if(mp.top ==null)console.error('Trường top là bắt buộc');
if(mp.time == null)mp.time = 1000;
...
; optinal
if(mp.name ==null)console.error('Trường name là bắt buộc');
if(mp.rotate ==null)console.error('Trường rotate là bắt buộc');
if(mp.time == null)mp.time = 1000;
...
; optinal
if(mp.name ==null)console.error('Trường name là bắt buộc');
if(mp.scaleX ==null)console.error('Trường scaleX là bắt buộc');
if(mp.scaleY ==null)console.error('Trường scaleY là bắt buộc');
if(mp.time == null)mp.time = 1000;
; Live2Dモデルの移動[Live2Dtyrano.js]

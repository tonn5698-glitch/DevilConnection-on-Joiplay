...
[tb_start_text mode=1 ]
#でびるん
Biến thành búp bê rồi…đm kiểu kết thúc[r]đâu có ai muốn vậy! Không làm gì được cả
[_tb_end_text]

[chara_mod  name="劇場でび"  time="0"  cross="false"  storage="chara/15/dagya27.png"  ]
[tb_start_text mode=1 ]
#でびるん
[delay speed=300]・・・[resetdelay]nhưng mà đã ngủ cùng rồi[r]mềm mại và thơm lắm, hehe
[_tb_end_text]
...
[tb_start_text mode=1 ]
#でびるん
Ơ, hình như có ai đang nhìn mình[r]nhỉ…rốt cuộc đó là cái gì vậy?
[_tb_end_text]
...
[tb_start_text mode=1 ]
#でびるん
Fwaa～thôi kệ đi.[r][wait time=300]Làm lại từ đầu nào!
